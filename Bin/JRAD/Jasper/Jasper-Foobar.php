...
function JSP_FOOBAR_EVENT ($returnType = 'DATATYPE')
{
	...
	{
		$fieldArray = array('image','name','event_date','event_time','event_venue','about');
...
function JSP_FOOBAR_CLONE ($table, $numrows = 100)
{
...
function JSP_FOOBAR_FORMFIL ()
{
	if (isset($_GET['BLN_FORMS_FOOBAR']))	
	{
		...
		{
			$postArray['username'] = JSP_SSQL_USER;
			$postArray['password'] = JSP_SSQL_PASSWORD;
		}		
		return $postArray;
	}
	else

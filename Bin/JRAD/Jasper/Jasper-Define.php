...
function JSP_DEFINE ()
{
	...
	(
		...
		'JSP_ERROR_ACCOUNT','JSP_ERROR_FILE','JSP_ERROR_FOLDER','JSP_ERROR_MAIL','JSP_ERROR_PAGE',
		'JSP_PAGE_LOOP','JSP_PAGE_URL','JSP_PAGE_ROOT','JSP_PAGE_FILE','JSP_PAGE_NAME',
		...
		'JSP_TABLE_ADMIN','JSP_TABLE_USER','JSP_TABLE_ALBUM','JSP_TABLE_SLIDE','JSP_TABLE_GALLERY','JSP_TABLE_EVENT','JSP_TABLE_PDF','JSP_TABLE_VIDEO','JSP_TABLE_UPLOADS','JSP_TABLE_KEYLOG','JSP_TABLE_VISITOR',
...
define('JSP_SUPER_ADMIN', 'info@hwplabs.com');

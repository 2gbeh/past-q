...
function BLN_DISPLAY_ILIST (param)
{
	var dt = document.querySelectorAll('.JSP_DISPLAY_ILIST dt');
	var dd = document.querySelectorAll('.JSP_DISPLAY_ILIST dd');
	var sign = document.querySelectorAll('.JSP_DISPLAY_ILIST .sign');		
